...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1400_RPDOCommunicationParameter = {
        ...
        .COB_IDUsedByRPDO = 0x0000020E,
        .transmissionType = 0xFE,
        .eventTimer = 0x0000
    },
    .x1600_RPDOMappingParameter = {
        .numberOfMappedApplicationObjectsInPDO = 0x02,
        .applicationObject1 = 0x21000108,
        .applicationObject2 = 0x21000208,
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x280C_totalNumberOfBatteryCycles = {
        ...
        .totalNumberOfBatteryCycles = 0x0000
    },
    .x280D_SW_AsmVersion = {
        .highestSub_indexSupported = 0x02,
        .SWAV1 = 0x00000000,
        .SW_AsmVersion = 0x00000000
    },
    .x3000_batteryEfficiencyChargeInVsDischargeOut = {
        .highestSub_indexSupported = 0x01,
        .batteryEfficiencyChargeInVsDischargeOut = 0x00
    },
    .x3001_nominalSOH = {
        .highestSub_indexSupported = 0x04,
        .nominalBatteryEnergyKWh = 0x00000000,
        .nominalBatteryVoltageV = 0x0000,
        .SOH_WarrantyValuePercentOfBeginningLifeOfCapacityAh = 0x0000,
        .SOH_RunningValuePercentOfBeginningLifeOfCapacityAh = 0x0000
    },
    .x3002_lifetimeAvg = {
        .highestSub_indexSupported = 0x05,
    ...
    .x3004_remainingHoursLeftForWarranty = {
        .highestSub_indexSupported = 0x01,
        .remainingHoursLeftForWarranty = 0x00000000
    },
    .x3005_BMS_Data = {
    ...
    .x3008_totalTimeReceivingCurrentInChargeMode = {
        .highestSub_indexSupported = 0x01,
        .totalTimeReceivingCurrentInChargeMode = 0x00000000
    },
    .x3009_totalTimeInChargeMode = {
        .highestSub_indexSupported = 0x01,
        .totalTimeInChargeMode = 0x00000000
    },
    .x300A_thermistors_sub0 = 0x04,
    .x300A_thermistors = {511, 511, 511, 511},
    .x300B_cumulativeTotalDischargeKWh = {
        .highestSub_indexSupported = 0x01,
        .cumulativeTotalDischargeKWh = 0x00000000
    },
    .x300C_energyRemainingForBatteryWarrantyKWh = {
        .highestSub_indexSupported = 0x01,
        .energyRemainingForBatteryWarrantyKWh = 0x00000000
    },
    .x300D_cumulativeTotalBatteryRegenKWh = {
        .highestSub_indexSupported = 0x01,
        .cumulativeTotalBatteryRegenKWh = 0x00000000
    },
    .x300E_GPS_Derate = {
        .highestSub_indexSupported = 0x05,
        .GPS_Location = 0x00000000,
        .GPS_CAN_ProtocolSpecificationRev = 0x00,
        .highTemperatureDerateStartC_F_Discharge = 0x0000,
        .lowTemperatureDerateStartC_F_Discharge = 0,
        .liftLockoutStartCSOC = 0x0000
    },
    .x300F_chargerStats = {
        .highestSub_indexSupported = 0x06,
        .totalNumberOfChargerFaults = 0x00000000,
        .numberOfChargesCompletedWithoutCellBalancing = 0x00000000,
        .timestampOfLastChargeCompletedWithoutCellBalancing = 0x00000000,
        .numberOfChargesCompletedWithCellBalancing = 0x00000000,
        .timestampOfLastChargeCompletedWithCellBalancing = 0x00000000,
        .warrantableBatteryEnergyKWh = 0x00000000
    },
...
typedef struct {
    ...
    OD_obj_record_t o_2100_mainTruckControllerCrossCheck[3];
    OD_obj_record_t o_280C_totalNumberOfBatteryCycles[2];
    OD_obj_record_t o_280D_SW_AsmVersion[3];
    OD_obj_record_t o_3000_batteryEfficiencyChargeInVsDischargeOut[2];
    OD_obj_record_t o_3001_nominalSOH[5];
    OD_obj_record_t o_3002_lifetimeAvg[6];
    OD_obj_record_t o_3004_remainingHoursLeftForWarranty[2];
    ...
    OD_obj_record_t o_3008_totalTimeReceivingCurrentInChargeMode[2];
    OD_obj_record_t o_3009_totalTimeInChargeMode[2];
    OD_obj_array_t o_300A_thermistors;
    OD_obj_record_t o_300B_cumulativeTotalDischargeKWh[2];
    OD_obj_record_t o_300C_energyRemainingForBatteryWarrantyKWh[2];
    OD_obj_record_t o_300D_cumulativeTotalBatteryRegenKWh[2];
    OD_obj_record_t o_300E_GPS_Derate[6];
    OD_obj_record_t o_300F_chargerStats[7];
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2100_mainTruckControllerCrossCheck = {
        {
            .dataOrig = &OD_RAM.x2100_mainTruckControllerCrossCheck.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
    ...
    .o_280C_totalNumberOfBatteryCycles = {
        {
            .dataOrig = &OD_RAM.x280C_totalNumberOfBatteryCycles.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x280C_totalNumberOfBatteryCycles.totalNumberOfBatteryCycles,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_280D_SW_AsmVersion = {
        {
            .dataOrig = &OD_RAM.x280D_SW_AsmVersion.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x280D_SW_AsmVersion.SWAV1,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x280D_SW_AsmVersion.SW_AsmVersion,
            .subIndex = 2,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_3000_batteryEfficiencyChargeInVsDischargeOut = {
        {
            .dataOrig = &OD_RAM.x3000_batteryEfficiencyChargeInVsDischargeOut.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x3000_batteryEfficiencyChargeInVsDischargeOut.batteryEfficiencyChargeInVsDischargeOut,
            .subIndex = 1,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        }
    ...
    .o_3001_nominalSOH = {
        {
            .dataOrig = &OD_RAM.x3001_nominalSOH.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x3001_nominalSOH.nominalBatteryEnergyKWh,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x3001_nominalSOH.nominalBatteryVoltageV,
            .subIndex = 2,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x3001_nominalSOH.SOH_WarrantyValuePercentOfBeginningLifeOfCapacityAh,
            .subIndex = 3,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x3001_nominalSOH.SOH_RunningValuePercentOfBeginningLifeOfCapacityAh,
            .subIndex = 4,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_3004_remainingHoursLeftForWarranty = {
        {
            .dataOrig = &OD_RAM.x3004_remainingHoursLeftForWarranty.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x3004_remainingHoursLeftForWarranty.remainingHoursLeftForWarranty,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_3008_totalTimeReceivingCurrentInChargeMode = {
        {
            .dataOrig = &OD_RAM.x3008_totalTimeReceivingCurrentInChargeMode.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x3008_totalTimeReceivingCurrentInChargeMode.totalTimeReceivingCurrentInChargeMode,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_3009_totalTimeInChargeMode = {
        {
            .dataOrig = &OD_RAM.x3009_totalTimeInChargeMode.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x3009_totalTimeInChargeMode.totalTimeInChargeMode,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_300B_cumulativeTotalDischargeKWh = {
        {
            .dataOrig = &OD_RAM.x300B_cumulativeTotalDischargeKWh.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x300B_cumulativeTotalDischargeKWh.cumulativeTotalDischargeKWh,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_300C_energyRemainingForBatteryWarrantyKWh = {
        {
            .dataOrig = &OD_RAM.x300C_energyRemainingForBatteryWarrantyKWh.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x300C_energyRemainingForBatteryWarrantyKWh.energyRemainingForBatteryWarrantyKWh,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_300D_cumulativeTotalBatteryRegenKWh = {
        {
            .dataOrig = &OD_RAM.x300D_cumulativeTotalBatteryRegenKWh.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x300D_cumulativeTotalBatteryRegenKWh.cumulativeTotalBatteryRegenKWh,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_300E_GPS_Derate = {
        {
            .dataOrig = &OD_RAM.x300E_GPS_Derate.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x300E_GPS_Derate.GPS_Location,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x300E_GPS_Derate.GPS_CAN_ProtocolSpecificationRev,
            .subIndex = 2,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x300E_GPS_Derate.highTemperatureDerateStartC_F_Discharge,
            .subIndex = 3,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x300E_GPS_Derate.lowTemperatureDerateStartC_F_Discharge,
            .subIndex = 4,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x300E_GPS_Derate.liftLockoutStartCSOC,
            .subIndex = 5,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_300F_chargerStats = {
        {
            .dataOrig = &OD_RAM.x300F_chargerStats.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x300F_chargerStats.totalNumberOfChargerFaults,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x300F_chargerStats.numberOfChargesCompletedWithoutCellBalancing,
            .subIndex = 2,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x300F_chargerStats.timestampOfLastChargeCompletedWithoutCellBalancing,
            .subIndex = 3,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x300F_chargerStats.numberOfChargesCompletedWithCellBalancing,
            .subIndex = 4,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x300F_chargerStats.timestampOfLastChargeCompletedWithCellBalancing,
            .subIndex = 5,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x300F_chargerStats.warrantableBatteryEnergyKWh,
            .subIndex = 6,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 4
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2100, 0x03, ODT_REC, &ODObjs.o_2100_mainTruckControllerCrossCheck, NULL},
    {0x280C, 0x02, ODT_REC, &ODObjs.o_280C_totalNumberOfBatteryCycles, NULL},
    {0x280D, 0x03, ODT_REC, &ODObjs.o_280D_SW_AsmVersion, NULL},
    {0x3000, 0x02, ODT_REC, &ODObjs.o_3000_batteryEfficiencyChargeInVsDischargeOut, NULL},
    {0x3001, 0x05, ODT_REC, &ODObjs.o_3001_nominalSOH, NULL},
    {0x3002, 0x06, ODT_REC, &ODObjs.o_3002_lifetimeAvg, NULL},
    {0x3004, 0x02, ODT_REC, &ODObjs.o_3004_remainingHoursLeftForWarranty, NULL},
    ...
    {0x3008, 0x02, ODT_REC, &ODObjs.o_3008_totalTimeReceivingCurrentInChargeMode, NULL},
    {0x3009, 0x02, ODT_REC, &ODObjs.o_3009_totalTimeInChargeMode, NULL},
    {0x300A, 0x05, ODT_ARR, &ODObjs.o_300A_thermistors, NULL},
    {0x300B, 0x02, ODT_REC, &ODObjs.o_300B_cumulativeTotalDischargeKWh, NULL},
    {0x300C, 0x02, ODT_REC, &ODObjs.o_300C_energyRemainingForBatteryWarrantyKWh, NULL},
    {0x300D, 0x02, ODT_REC, &ODObjs.o_300D_cumulativeTotalBatteryRegenKWh, NULL},
    {0x300E, 0x06, ODT_REC, &ODObjs.o_300E_GPS_Derate, NULL},
    {0x300F, 0x07, ODT_REC, &ODObjs.o_300F_chargerStats, NULL},
