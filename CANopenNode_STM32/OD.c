...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1600_RPDOMappingParameter = {
        ...
        .applicationObject1 = 0x30300110,
        .applicationObject2 = 0x30200108,
        .applicationObject3 = 0x30100120,
    ...
    .x1A01_TPDOMappingParameter = {
        ...
        .applicationObject1 = 0x30020108,
        .applicationObject2 = 0x30020208,
        .applicationObject3 = 0x30020308,
        .applicationObject4 = 0x30020408,
        .applicationObject5 = 0x30020508,
        .applicationObject6 = 0x30020608,
        .applicationObject7 = 0x00000000,
        .applicationObject8 = 0x00000000
    },
    .x1F80_NMTStartup = 0x00000000,
    .x3000_command_Word = 0x0000,
    .x3001_large_Display = {
        .large_Display_Length = 0x03,
        .large_Text_Char_1 = 0x00,
        .large_Text_Char_2 = 0x00,
        .large_Text_Char_3 = 0x00
    },
    .x3002_small_Display = {
        .small_Display_Length = 0x06,
        .small_Text_Char_1 = 0x00,
        .small_Text_Char_2 = 0x00,
        .small_Text_Char_3 = 0x00,
        .small_Text_Char_4 = 0x00,
        .small_Text_Char_5 = 0x00,
        .small_Text_Char_6 = 0x00
    },
    .x3003_LEDCommand = 0x00,
    .x3005_backlightPercent = 0x00,
    .x3010_hourMeter = {
        .hourMeterEnable = 0x00,
        .hourMeterReset = 0x00
    },
    .x3020_BDI_sub0 = 0x01,
    .x3020_BDI = {0x00},
    .x3030_bplus_sub0 = 0x01,
    .x3030_bplus = {0x0000}
};
...
OD_ATTR_ROM OD_ROM_t OD_ROM = {
    ...
    .x1A00_TPDOMappingParameter = {
        ...
        .applicationObject1 = 0x30000010,
        .applicationObject2 = 0x30010108,
        .applicationObject3 = 0x30010208,
        .applicationObject4 = 0x30010308,
        .applicationObject5 = 0x30050008,
        .applicationObject6 = 0x30100208,
        .applicationObject7 = 0x30030008,
        .applicationObject8 = 0x00000000
    }
};
...
typedef struct {
    ...
    OD_obj_var_t o_3000_command_Word;
    OD_obj_record_t o_3001_large_Display[4];
    OD_obj_record_t o_3002_small_Display[7];
    OD_obj_var_t o_3003_LEDCommand;
    OD_obj_var_t o_3005_backlightPercent;
    OD_obj_record_t o_3010_hourMeter[4];
    OD_obj_array_t o_3020_BDI;
    OD_obj_array_t o_3030_bplus;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_3001_large_Display = {
        ...
        {
            .dataOrig = &OD_PERSIST_COMM.x3001_large_Display.large_Text_Char_1,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3001_large_Display.large_Text_Char_2,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3001_large_Display.large_Text_Char_3,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        }
    },
    .o_3002_small_Display = {
        {
            .dataOrig = &OD_PERSIST_COMM.x3002_small_Display.small_Display_Length,
            .subIndex = 0,
            .attribute = ODA_SDO_R | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3002_small_Display.small_Text_Char_1,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3002_small_Display.small_Text_Char_2,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3002_small_Display.small_Text_Char_3,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3002_small_Display.small_Text_Char_4,
            .subIndex = 4,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3002_small_Display.small_Text_Char_5,
            .subIndex = 5,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3002_small_Display.small_Text_Char_6,
            .subIndex = 6,
            .attribute = ODA_SDO_RW | ODA_TRPDO,
            .dataLength = 1
        }
    ...
    .o_3003_LEDCommand = {
        .dataOrig = &OD_PERSIST_COMM.x3003_LEDCommand,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_3005_backlightPercent = {
        .dataOrig = &OD_PERSIST_COMM.x3005_backlightPercent,
        .attribute = ODA_SDO_RW | ODA_TRPDO,
        .dataLength = 1
    },
    .o_3010_hourMeter = {
        ...
        {
            .dataOrig = &OD_PERSIST_COMM.x3010_hourMeter.hourMeterEnable,
            .subIndex = 2,
            .attribute = ODA_TRPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x3010_hourMeter.hourMeterReset,
            .subIndex = 3,
            .attribute = ODA_TRPDO,
            .dataLength = 1
        }
    ...
    .o_3020_BDI = {
        .dataOrig0 = &OD_PERSIST_COMM.x3020_BDI_sub0,
        .dataOrig = &OD_PERSIST_COMM.x3020_BDI[0],
        .attribute0 = ODA_SDO_R,
    ...
    .o_3030_bplus = {
        .dataOrig0 = &OD_PERSIST_COMM.x3030_bplus_sub0,
        .dataOrig = &OD_PERSIST_COMM.x3030_bplus[0],
        .attribute0 = ODA_SDO_R,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x3000, 0x01, ODT_VAR, &ODObjs.o_3000_command_Word, NULL},
    {0x3001, 0x04, ODT_REC, &ODObjs.o_3001_large_Display, NULL},
    {0x3002, 0x07, ODT_REC, &ODObjs.o_3002_small_Display, NULL},
    {0x3003, 0x01, ODT_VAR, &ODObjs.o_3003_LEDCommand, NULL},
    {0x3005, 0x01, ODT_VAR, &ODObjs.o_3005_backlightPercent, NULL},
    {0x3010, 0x04, ODT_REC, &ODObjs.o_3010_hourMeter, NULL},
    {0x3020, 0x02, ODT_ARR, &ODObjs.o_3020_BDI, NULL},
    {0x3030, 0x02, ODT_ARR, &ODObjs.o_3030_bplus, NULL},
